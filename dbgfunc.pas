...
procedure DebugMsg(sMsg: AnsiString; bForcePrint: Boolean = False);
...
procedure InfoMsg(sMsg: AnsiString; bForcePrint: Boolean = False);
...
procedure ErrorMsg(sMsg: AnsiString; bForcePrint: Boolean = False);
...
procedure WarningMsg(sMsg: AnsiString; bForcePrint: Boolean = False);
...
procedure FatalMsg(sMsg: AnsiString; bForcePrint: Boolean = False);
...
procedure ServiceMsg(sMsg: AnsiString; bForcePrint: Boolean = False);
...
procedure DebugMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean = False);
{
...
procedure InfoMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean = False);
{
...
procedure ServiceMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean = False);
{
...
procedure ErrorMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean = False);
{
...
procedure WarningMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean = False);
{
...
procedure FatalMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean = False);
...
begin
  ...
  begin
    // С Windows системами мы можем пользоваться функцией перекодировки Utf8ToAnsi
    Result := Utf8ToAnsi(sTxt);
  end
  else
...
procedure DebugMsg(sMsg: AnsiString; bForcePrint: Boolean);
begin
...
procedure InfoMsg(sMsg: AnsiString; bForcePrint: Boolean);
begin
    if (GetDebugMode()) or (bForcePrint) then
...
procedure ErrorMsg(sMsg: AnsiString; bForcePrint: Boolean);
begin
    if (GetDebugMode()) or (bForcePrint) then
...
procedure WarningMsg(sMsg: AnsiString; bForcePrint: Boolean);
begin
    if (GetDebugMode()) or (bForcePrint) then
...
procedure FatalMsg(sMsg: AnsiString; bForcePrint: Boolean);
var
...
procedure ServiceMsg(sMsg: AnsiString; bForcePrint: Boolean);
begin
    if (GetDebugMode()) or (bForcePrint) then
...
procedure DebugMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean);
begin
  DebugMsg(Format(sMsgFmt, aArgs), bForcePrint);
end;
...
procedure InfoMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean);
begin
  InfoMsg(Format(sMsgFmt, aArgs), bForcePrint);
end;
...
procedure ServiceMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean);
begin
  ServiceMsg(Format(sMsgFmt, aArgs), bForcePrint);
end;
...
procedure ErrorMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean);
begin
  ErrorMsg(Format(sMsgFmt, aArgs), bForcePrint);
end;
...
procedure WarningMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean);
begin
  WarningMsg(Format(sMsgFmt, aArgs), bForcePrint);
end;
...
procedure FatalMsgFmt(sMsgFmt: AnsiString; const aArgs : Array Of Const; bForcePrint: Boolean);
begin
  FatalMsg(Format(sMsgFmt, aArgs), bForcePrint);
end;
